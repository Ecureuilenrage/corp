...
exports.formatExtensionValidation = formatExtensionValidation;
function formatExtensionValidation(result) {
    const lines = [
    ...
    if (result.registration) {
        ...
        if (result.registration.executionAdapter) {
            ...
            lines.push(`Env requis: ${formatList(result.registration.executionAdapter.requiredEnvNames, "aucun")}`);
        }
